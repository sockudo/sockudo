...
namespace SockudoServer.Tests.UnitTests
{
    ...
    public class When_using_push_helpers
    {
        ...
        public void Setup()
        {
            ...
            _restClient.ExecuteGetAsync<object>(Arg.Any<ISockudoRestRequest>())
            ...
            _restClient.ExecuteDeleteRawAsync(Arg.Any<ISockudoRestRequest>())
        ...
        {
            await _sockudo.PublishPushAsync<object>(new
            {
...
#pragma warning restore 4014
        ...
        {
            await _sockudo.ListChannelPushSubscriptionsAsync<object>(
...
#pragma warning restore 4014
        ...
        {
            await _sockudo.CancelScheduledPushAsync<object>("pub_123").ConfigureAwait(false);
...
#pragma warning restore 4014
        ...
        public void schedule_push_requires_notBeforeMs()
        {
            var ex = Assert.ThrowsAsync<ArgumentException>(async () =>
                await _sockudo.SchedulePushAsync<object>(new
                {
                    recipients = new[] { new { type = "channel", channel = "orders" } },
        ...
        private static bool RequestBodyHasAsyncPublishDefaults(ISockudoRestRequest request)
        {
