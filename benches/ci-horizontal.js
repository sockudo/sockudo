 ...
 *
 * 2. Run the Rust senders based on the amount of messages per second you want to receive.
 *    The sending rate influences the final benchmark.
 *
 * Low, 1 message per second:
 * cargo run --release --manifest-path benches/sender/Cargo.toml -- --interval 1 --port 6001
 * cargo run --release --manifest-path benches/sender/Cargo.toml -- --interval 1 --port 6002
 *
 * Mild, 2 messages per second:
 * cargo run --release --manifest-path benches/sender/Cargo.toml -- --interval 0.5 --port 6001
 * cargo run --release --manifest-path benches/sender/Cargo.toml -- --interval 0.5 --port 6002
 *
 * Overkill, 10 messages per second:
 * cargo run --release --manifest-path benches/sender/Cargo.toml -- --interval 0.1 --port 6001
 * cargo run --release --manifest-path benches/sender/Cargo.toml -- --interval 0.1 --port 6002
 */
