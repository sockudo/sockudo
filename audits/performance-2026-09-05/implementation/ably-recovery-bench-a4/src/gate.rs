// Isolated A4: baseline gate code with only Arc ownership sharing; retains baseline sizing.
...
fn push_bounded_recovery_message(gate: &mut AblyAttachGate, message: Arc<AblyProtocolMessage>) {
