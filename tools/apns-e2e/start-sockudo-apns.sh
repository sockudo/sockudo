...
export PUSH_APNS_TEAM_ID="${PUSH_APNS_TEAM_ID:-69QGT49729}"
export PUSH_APNS_KEY_ID="${PUSH_APNS_KEY_ID:-4Y9K5S73KH}"
export PUSH_APNS_PRIVATE_KEY_PATH="${PUSH_APNS_PRIVATE_KEY_PATH:-/Users/radudiaconu/Desktop/Code/Rust/sockudo/AuthKey_4Y9K5S73KH.p8}"
