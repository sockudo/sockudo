...
>
  <div className="ai-model-grid">
    <div className="ai-model-column">
      <span className="ai-diagram-label">Run sources</span>
...
<div
  ...
  role="img"
  aria-label="AI Transport run lifecycle from client input through Sockudo persistence, agent output, append rollup, and final history state."
>
  ...
  <ol className="turn-lifecycle-steps">
    <li>
      <span>01</span>
      <div>
        <strong>Input creates the run</strong>
        <p>
          {
    ...
    <li>
      <span>05</span>
      <div>
        <strong>Run closes into durable history</strong>
        <p>
          {
