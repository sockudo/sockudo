...
| `username` | `string?` | `null` | Optional username override after connecting |
| `password` | `string?` | `null` | Optional password override after connecting |
...
| `partitions_count` | `number` | `1` | Topic partitions created when `auto_create` is enabled |
| `partition_id` | `number` | `1` | Partition used by adapter listeners and publishers |
