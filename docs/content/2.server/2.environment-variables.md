...
| `QUEUE_DRIVER` | `string` | `redis` | Queue backend: `memory`, `redis`, `redis-cluster`, `nats`, `rabbitmq`, `kafka`, `pulsar`, `google-pubsub`, `sqs`, `sns`, `none` |
...
### Queue: NATS / RabbitMQ / Kafka / Pulsar / Google Pub/Sub
