...
pub use sockudo_types::socket::SocketId;
pub use sockudo_types::websocket::{BufferLimit, WebSocketBufferConfig};
...
pub struct ConnectionState {
    ...
    pub app: Option<ConnectionAppInfo>,
