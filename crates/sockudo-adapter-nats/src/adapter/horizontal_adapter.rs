...
pub type DeadNodeEvent = sockudo_adapter_local::adapter::horizontal_adapter::DeadNodeEvent;

/// Information about an orphaned presence member that needs cleanup.
pub type OrphanedMember = sockudo_adapter_local::adapter::horizontal_adapter::OrphanedMember;
